-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\hdlcoder_dwt\alpha4_level_dwt_tc.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha4_level_dwt_tc
-- Source Path: 4_level_dwt_tc
-- Hierarchy Level: 1
-- 
...
END alpha4_level_dwt_tc;


ARCHITECTURE rtl OF alpha4_level_dwt_tc IS
  ...
  SIGNAL phase_1_4                        : std_logic;
  SIGNAL phase_1_tmp_4                    : std_logic;
  SIGNAL count64                          : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL phase_all                        : std_logic;
  SIGNAL phase_0_5                        : std_logic;
  SIGNAL phase_0_tmp_5                    : std_logic;
  SIGNAL phase_1_5                        : std_logic;
  SIGNAL phase_1_tmp_5                    : std_logic;
...
BEGIN
  ...
  phase_0_tmp_3 <= '1' WHEN count16 = to_unsigned(15, 4) AND clk_enable = '1' ELSE '0';
  ...
  phase_1_tmp_3 <= '1' WHEN count16 = to_unsigned(0, 4) AND clk_enable = '1' ELSE '0';
  ...
  phase_0_tmp_4 <= '1' WHEN count32 = to_unsigned(31, 5) AND clk_enable = '1' ELSE '0';
  ...
  phase_1_tmp_4 <= '1' WHEN count32 = to_unsigned(0, 5) AND clk_enable = '1' ELSE '0';
  ...
  BEGIN
    ...
    ELSIF clk'event AND clk = '1' THEN
      IF clk_enable = '1' THEN
        phase_0_5 <= phase_0_tmp_5;
      END IF;
    END IF; 
  END PROCESS temp_process11;

  phase_0_tmp_5 <= '1' WHEN count64 = to_unsigned(63, 6) AND clk_enable = '1' ELSE '0';
  ...
  BEGIN
    ...
    ELSIF clk'event AND clk = '1' THEN
      IF clk_enable = '1' THEN
        phase_1_5 <= phase_1_tmp_5;
      END IF;
    END IF; 
  END PROCESS temp_process12;

  phase_1_tmp_5 <= '1' WHEN count64 = to_unsigned(0, 6) AND clk_enable = '1' ELSE '0';
  ...
  enb_1_16_1 <=  phase_1_3 AND clk_enable;

  enb_1_32_0 <=  phase_0_4 AND clk_enable;

  enb_1_32_1 <=  phase_1_4 AND clk_enable;

  enb_1_64_0 <=  phase_0_5 AND clk_enable;

  enb_1_64_1 <=  phase_1_5 AND clk_enable;
