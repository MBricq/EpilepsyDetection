-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\hdlcoder_dwt\alpha1_level_dwt5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha1_level_dwt5
-- Source Path: hdlcoder_dwt/4_level_dwt/1_level_dwt5
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END alpha1_level_dwt5;


ARCHITECTURE rtl OF alpha1_level_dwt5 IS

  -- Component Declarations
  COMPONENT Discrete_FIR_Filter_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Discrete_FIR_Filter1_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Discrete_FIR_Filter_block4
    USE ENTITY work.Discrete_FIR_Filter_block4(rtl);

  FOR ALL : Discrete_FIR_Filter1_block4
    USE ENTITY work.Discrete_FIR_Filter1_block4(rtl);
...
BEGIN
  u_Discrete_FIR_Filter : Discrete_FIR_Filter_block4
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Discrete_FIR_Filter1 : Discrete_FIR_Filter1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
  ...
  RT2_out1 <= enable WHEN enb_1_64_1 = '1' ELSE
      RT2_bypass_reg;
