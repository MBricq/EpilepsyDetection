-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\hdlcoder_dwt\alpha1_level_dwt1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha1_level_dwt1
-- Source Path: hdlcoder_dwt/4_level_dwt/1_level_dwt1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END alpha1_level_dwt1;


ARCHITECTURE rtl OF alpha1_level_dwt1 IS
  ...
  COMPONENT Discrete_FIR_Filter1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : Discrete_FIR_Filter1_block
    USE ENTITY work.Discrete_FIR_Filter1_block(rtl);

  -- Signals
  SIGNAL RT2_bypass_reg                   : std_logic;  -- ufix1
  SIGNAL RT2_out1                         : std_logic;
  SIGNAL switch_compare_1                 : std_logic;
  SIGNAL Constant_out1                    : signed(69 DOWNTO 0);  -- sfix70_En12
  ...
  SIGNAL Discrete_FIR_Filter_out1         : std_logic_vector(69 DOWNTO 0);  -- ufix70
  SIGNAL Discrete_FIR_Filter_out1_signed  : signed(69 DOWNTO 0);  -- sfix70_En12
  SIGNAL Downsample_out1                  : signed(69 DOWNTO 0);  -- sfix70_En12
  SIGNAL Switch_out1                      : signed(69 DOWNTO 0);  -- sfix70_En12
  ...
  SIGNAL Discrete_FIR_Filter1_out1        : std_logic_vector(69 DOWNTO 0);  -- ufix70
  SIGNAL Discrete_FIR_Filter1_out1_signed : signed(69 DOWNTO 0);  -- sfix70_En12
  SIGNAL Downsample1_out1                 : signed(69 DOWNTO 0);  -- sfix70_En12
  SIGNAL Switch1_out1                     : signed(69 DOWNTO 0);  -- sfix70_En12
...
BEGIN
  u_Discrete_FIR_Filter : Discrete_FIR_Filter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => enb_1_2_0,
              Discrete_FIR_Filter_in => s_in,  -- sfix51_En12
              Discrete_FIR_Filter_coeff => db4_wavelet_out1_1,  -- int16 [8]
              Discrete_FIR_Filter_out => Discrete_FIR_Filter_out1  -- sfix70_En12
              );

  u_Discrete_FIR_Filter1 : Discrete_FIR_Filter1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => enb_1_2_0,
              Discrete_FIR_Filter1_in => s_in,  -- sfix51_En12
              Discrete_FIR_Filter1_coeff => db4_scaling_out1_1,  -- int16 [8]
              Discrete_FIR_Filter1_out => Discrete_FIR_Filter1_out1  -- sfix70_En12
              );
  ...
  BEGIN
    IF reset = '1' THEN
      Downsample_out1 <= to_signed(0, 70);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_0 = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      Downsample1_out1 <= to_signed(0, 70);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_0 = '1' THEN
