-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\full_system_nios_id7\alpha1_level_dwt1.vhd
...
-- Source Path: full_system_nios_id7/full_system/1_level_dwt1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF alpha1_level_dwt1 IS
  ...
  SIGNAL Discrete_FIR_Filter1_out1        : std_logic_vector(53 DOWNTO 0);  -- ufix54
  SIGNAL Discrete_FIR_Filter1_out1_signed : signed(53 DOWNTO 0);  -- sfix54_En4
  SIGNAL Downsample1_out1                 : signed(53 DOWNTO 0);  -- sfix54_En4
  SIGNAL Switch1_out1                     : signed(53 DOWNTO 0);  -- sfix54_En4
...
BEGIN
  u_Discrete_FIR_Filter : Discrete_FIR_Filter
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => enb_1_2_0,
              Discrete_FIR_Filter_in => s_in,  -- sfix35_En4
  ...
  u_Discrete_FIR_Filter1 : Discrete_FIR_Filter1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2_0 => enb_1_2_0,
              Discrete_FIR_Filter1_in => s_in,  -- sfix35_En4
              Discrete_FIR_Filter1_coeff => db4_scaling_out1_1,  -- int16 [8]
              Discrete_FIR_Filter1_out => Discrete_FIR_Filter1_out1  -- sfix54_En4
              );
  ...
  BEGIN
    IF reset = '1' THEN
      Downsample1_out1 <= to_signed(0, 54);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_4_0 = '1' THEN
