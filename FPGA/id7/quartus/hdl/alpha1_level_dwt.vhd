-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\full_system_nios_id7\alpha1_level_dwt.vhd
...
-- Source Path: full_system_nios_id7/full_system/1_level_dwt
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF alpha1_level_dwt IS
  ...
  COMPONENT Discrete_FIR_Filter1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Discrete_FIR_Filter1_in         :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En4
          Discrete_FIR_Filter1_coeff      :   IN    vector_of_std_logic_vector16(0 TO 7);  -- int16 [8]
          Discrete_FIR_Filter1_out        :   OUT   std_logic_vector(34 DOWNTO 0)  -- sfix35_En4
          );
  END COMPONENT;
  ...
  SIGNAL Discrete_FIR_Filter1_out1        : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL Discrete_FIR_Filter1_out1_signed : signed(34 DOWNTO 0);  -- sfix35_En4
  SIGNAL Downsample1_out1                 : signed(34 DOWNTO 0);  -- sfix35_En4
  SIGNAL Switch1_out1                     : signed(34 DOWNTO 0);  -- sfix35_En4
...
BEGIN
  u_Discrete_FIR_Filter1 : Discrete_FIR_Filter1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Discrete_FIR_Filter1_in => s_in,  -- sfix16_En4
              Discrete_FIR_Filter1_coeff => db4_scaling_out1_1,  -- int16 [8]
              Discrete_FIR_Filter1_out => Discrete_FIR_Filter1_out1  -- sfix35_En4
              );
  ...
  BEGIN
    IF reset = '1' THEN
      Downsample1_out1 <= to_signed(0, 35);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_2_0 = '1' THEN
  ...
  Switch1_out1 <= Constant_out1 WHEN switch_compare_1 = '0' ELSE
      Downsample1_out1;
