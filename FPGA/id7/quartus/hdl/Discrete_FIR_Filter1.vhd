-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\full_system_nios_id7\Discrete_FIR_Filter1.vhd
...
-- Source Path: full_system_nios_id7/full_system/1_level_dwt/Discrete FIR Filter1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Discrete_FIR_Filter1 IS
  ...
  -- Signals
  SIGNAL Discrete_FIR_Filter1_in_signed   : signed(15 DOWNTO 0);  -- sfix16_En4
