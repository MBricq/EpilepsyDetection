-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\full_system_nios_id2\predictor.vhd
...
-- 
-- Module: predictor
-- Source Path: full_system_nios_id2/full_system/predictor
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF predictor IS
  ...
  SIGNAL variable_signed                  : signed(31 DOWNTO 0);  -- sfix32_En8
  SIGNAL stateControl_1                   : std_logic;
  SIGNAL stateControl_2                   : std_logic;
  SIGNAL enb_gated                        : std_logic;
  SIGNAL Delay2_out1                      : signed(31 DOWNTO 0);  -- sfix32_En8
